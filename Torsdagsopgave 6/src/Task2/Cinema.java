...
public class Cinema {
    ...
    public Cinema(int rows, int seats) {
        this.seats = new String[rows][seats]; //RETTELSE: Flyttet denne sætning en linje op, så den kommer før linje 10.
        this.seats[0][0] = "X";
    ...
    public boolean cancelReservation(int row, int seat) {
        if (seats[row][seat].equals("X")) { //RETTELSE: rettet fra lille x til stort X.
            seats[row][seat] = "O";
            return true;
        }
        return false;
